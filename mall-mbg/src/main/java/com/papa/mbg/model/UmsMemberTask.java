...
public class UmsMemberTask implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getIntergration() == null ? other.getIntergration() == null : this.getIntergration().equals(other.getIntergration()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getIntergration() == null) ? 0 : getIntergration().hashCode());
